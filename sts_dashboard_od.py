...
def run():
    ...
    cap = cv2.VideoCapture("jak.mp4")  # 0 for 1st webcam
    ...
    while True:
        ...
        blob = cv2.dnn.blobFromImage(
            frame, 0.00392, (210, 210), (0, 0, 0), True, crop=False)  # reduce 416 to 320
        ...
        for i in range(len(boxes)):
            if i in indexes:
                ...
                cv2.putText(frame, label+" "+str(round(confidence, 2)) + " Coor. :" + str(y) + "," + str(x),
                            (x, y+30), font, 1, (255, 255, 255), 2)
                if y > 300 and x < 450 and x > 100:
                    print("terlalu dekat")  # Aktifkan relay
